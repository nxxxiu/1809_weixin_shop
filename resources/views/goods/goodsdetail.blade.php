...
<div>
    <div>
        ...
        <ul>
            ...
            <li>浏览次数：{{$view}}</li>
            <li>商品图片：<br>
                <img src="http://www.cccute.com/img/{{$data['goods_img']}}" alt="暂无图片" width="170" height="200">
            </li>
...
<script>
    ...
    wx.ready(function () {   //需在用户可能点击分享按钮前就先调用
        wx.updateAppMessageShareData({
            title: '旺仔', // 分享标题
            desc: 'emmmm....', // 分享描述
            link: 'http://www.cccute.com/goodsdetail/'+"{{$data['goods_id']}}", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
